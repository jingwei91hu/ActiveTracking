...
from . doppler_sensor_3d_utils import *
from . range_sensor_3d_utils import *

import torch

class EnsembledSensors3D(object):
    
    def __init__(self,n_rangesensor,states):
        self.states = states #sensor states
        self.n_rangesensor = n_rangesensor
        self.ranging = RangingSensors3D(states[:,:n_rangesensor])
        self.doppler = DopplerSensors3D(states[:,n_rangesensor:])
...
class EnsembledSensor3DTorchUtils: 
    
    def __init__(self,n_rangesensor):
        self.n_rangesensor = n_rangesensor
        self.rs = RangeSensor3DTorchUtils()
        self.ds = DopplerSensor3DTorchUtils()
...
__all__=['EnsembledSensors3D','EnsembledSensor3DTorchUtils']